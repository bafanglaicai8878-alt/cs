...
def show_info_dialog():
    ...
    tk.Label(root, text="CS Steam 游戏盒子",
...
def show_banner(backend: CaiBackend):
    ...
    log.info('CS Steam 游戏盒子')
    log.info('MIT License')
    log.info('仓库: https://github.com/bafanglaicai8878-alt/cs')
...
async def handle_repo_selection(backend: CaiBackend, items: list, add_all_dlc: bool, patch_depot_key: bool):
    ...
    # 内置GitHub清单库
    builtin_github_repos = ['luomojim/ManifestAutoUpdate', 'Auiowu/ManifestAutoUpdate', 'SteamAutoCracks/ManifestHub']
